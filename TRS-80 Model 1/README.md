...
![Example ROM](/Images/01.png)

## Individual ROMs

These are individual ROMs to be used on its own.

|Name|Source|Comment|Character Set|On Screen|
|-|-|-|-|-|
|[01 - CG0 - First](/Individual/character_set_01.bin)|xtras|Floating a, no arrows, no pound sign, no descenders, no duplicate|~[01](/Images/01.png)|~[Bit0](/Images/Bit0.jpg)|
|[02](/Individual/character_set_01.bin)|RetroStack|No floating a, no arrows, no pound sign, no descenders, no duplicate|~[02](/Images/02.png)|~[Bit1](/Images/Bit1.jpg)|
|[03](/Individual/character_set_01.bin)|RetroStack|Floating a, arrows & pound sign, no descenders, no duplicate|~[03](/Images/03.png)|~[Bit2](/Images/Bit2.jpg)|
|[04](/Individual/character_set_01.bin)|RetroStack|No floating a, arrows & pound sign, no descenders, no duplicate|~[04](/Images/04.png)||
|[05](/Individual/character_set_01.bin)|RetroStack|Floating a, no arrows, no pound sign, descenders, no duplicate|~[05](/Images/05.png)|~[Bit4](/Images/Bit4.jpg])|
|[06](/Individual/character_set_01.bin)|RetroStack|No floating a, no arrows, no pound sign, descenders, no duplicate|~[06](/Images/06.png)||
|[07](/Individual/character_set_01.bin)|RetroStack|Floating a, arrows & pound sign, descenders, no duplicate|~[07](/Images/07.png)||
|[08](/Individual/character_set_01.bin)|RetroStack|No floating a, arrows & pound sign, descenders, no duplicate|~[08](/Images/08.png)||
|[09](/Individual/character_set_01.bin)|RetroStack|Floating a, no arrows, no pound sign, no descenders, duplicate|~[09](/Images/09.png)|~[Bit8](/Images/Bit8.jpg)|
|[10](/Individual/character_set_01.bin)|RetroStack|No floating a, no arrows, no pound sign, no descenders, duplicate|~[10](/Images/10.png)||
|[11](/Individual/character_set_01.bin)|RetroStack|Floating a, arrows & pound sign, no descenders, duplicate|~[11](/Images/11.png)||
|[12](/Individual/character_set_01.bin)|RetroStack|No floating a, arrows & pound sign, no descenders, duplicate|~[12](/Images/12.png)||
|[13](/Individual/character_set_01.bin)|RetroStack|Floating a, no arrows, no pound sign, descenders, duplicate|~[13](/Images/13.png)||
|[14](/Individual/character_set_01.bin)|RetroStack|No floating a, no arrows, no pound sign, descenders, duplicate|~[14](/Images/14.png)||
|[15](/Individual/character_set_01.bin)|RetroStack|Floating a, arrows & pound sign, descenders, duplicate|~[15](/Images/15.png)||
...
|[Kana](/Individual/character_set_01.bin)||Japanese|~[17](/Images/17.png)|~[Bit16_01](/Images/Bit16_01_Kana_Japanese.jpg)|
|[GenDon 3 6A](/Individual/character_set_01.bin)|(link)[https://forum.vcfed.org/index.php?threads/gendon3-improved-character-generator-for-the-model-i-discussion.59498/]|No mod is needed! (modified to fit)|~[18](/Images/18.png)|~[Bit16_02](/Images/Bit16_02_GenDon3_6A_Modified.jpg)|
|[GenDon 3 9E](/Individual/character_set_01.bin)|(link)[https://forum.vcfed.org/index.php?threads/gendon3-improved-character-generator-for-the-model-i-discussion.59498/]|No mod is needed! (modified to fit)|~[19](/Images/19.png)|~[Bit16_03](/Images/Bit16_03_GenDon3_9E_Modified.jpg)|
|[GenDon 3 -61](/Individual/character_set_01.bin)|(link)[https://forum.vcfed.org/index.php?threads/gendon3-improved-character-generator-for-the-model-i-discussion.59498/]|No mod is needed! (modified to fit)|~[20](/Images/20.png)|~[Bit16_04](/Images/Bit16_04_GenDon3-61_Modified.jpg)|
|[Set All](/Individual/character_set_01.bin)|RetroStack|Noise check; Debugging Set|~[21](/Images/21.png)|~[Bit16_05](/Images/Bit16_05_All_Set.jpg)|
|[Blank](/Individual/character_set_01.bin)|RetroStack|Noise check; Debugging Set|~[22](/Images/22.png)|~[Bit16_06](/Images/Bit16_06_Blank.jpg)|
|[Cross](/Individual/character_set_01.bin)|RetroStack|Alignment check; Debugging Set|~[23](/Images/23.png)|~[Bit16_07](/Images/Bit16_07_Cross.jpg)|
|[Xs](/Individual/character_set_01.bin)|RetroStack|Distortion check; Debugging Set|~[24](/Images/24.png)|~[Bit16_08](/Images/Bit16_08_Xs.jpg)|
|[Hitachi HD44780U](/Individual/character_set_01.bin)|Datasheet|LCD Display (modified to fit)|~[25](/Images/25.png)|~[Bit16_09](/Images/Bit16_09_Hitachi HD44780U_LCD_Display_Modified.jpg)|
|[Mullard SAA5050](/Individual/character_set_01.bin)|Datasheet|Teletext (modified to fit)|~[26](/Images/26.png)|~[Bit16_10](/Images/Bit16_10_Mullard_SAA5050_Teletext_Modified.jpg)|
|[Signetics 2513](/Individual/character_set_01.bin)|Datasheet|Used in Apple I (modified to fit)|~[27](/Images/27.png)|~[Bit16_11](/Images/Bit16_11_Signetics_2513_Modified.jpg)|
|[Motorola MC4847](/Individual/character_set_01.bin)|Datasheet|(modified to fit)|~[28](/Images/28.png)|~[Bit16_12](/Images/Bit16_12_Motorola_MC4847_Modified.jpg)|
|[Cyber](/Individual/character_set_01.bin)|(link)[http://www.6502.org/users/sjgray/computer/cbmchr/cbmchr.html]|(modified to fit)|~[29](/Images/29.png)|~[Bit16_13](/Images/Bit16_13_Cyber_Modified.jpg)|
|[Sinclair Spectrum](/Individual/character_set_01.bin)|?|(modified to fit)|~[30](/Images/30.png)|~[Bit16_14](/Images/Bit16_14_Sinclair_Spectrum_Modified.jpg)|
